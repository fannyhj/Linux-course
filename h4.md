...
Tämän jälkeen muuokkasin sshd_configia komennolla 'sudoedit /etc/ssh/sshd_config' lisäämällä portin 22 ja 2222 (valitsin tämän portin melkolailla nopan heitolla).
