...
base:
  '*':
    ...
    - hellouser
    - hellocmd
Kirjoitin tiedostoon siis tiedostojen nimet, joita käytän seuraavassa osassa tehtävää, jossa pitää käyttää viittä tilafunktiota pkg, file, service, user ja cmd. Tämän avulla komento 'sudo salt-call --local state.apply ajaa kaikki tekemäni tiedostot samanaikaisesti.
