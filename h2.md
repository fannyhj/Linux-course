...
Loin tämän jälkeen kansion komennolla 'sudo mkdir -p /srv/salt/hello/'. Siirryin sitten kansioon komennolla 'cd /srv/salt/hello'.
<img width="453" height="76" alt="image" src="https://github.com/user-attachments/assets/d9d6f598-d446-4d5d-864c-a52261279ea1" />

Muokkasin sitten tiedostoa init.sls, siirtymällä sinne komennolla 'sudoedit init.sls'. Kirjoitin tiedostoon sitten '/tmp/hellotero: file.managed'.
